...
class SupportCodeLibraryBuilder {
    constructor() {
        const methods = {
            ...
            defineStep: (0, util_1.deprecate)(this.defineStep('Unknown', () => this.stepDefinitionConfigs), '`defineStep` is deprecated, use `Given`, `When` or `Then` instead; see https://github.com/cucumber/cucumber-js/issues/2043'),
